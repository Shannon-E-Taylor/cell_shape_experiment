...
# https://github.com/GFleishman/cellpose/blob/distributed/cellpose/distribute.py

def convert_tif_to_zarr(infile, outfile): 
    # https://gist.github.com/GenevieveBuckley/d94351adcc61cb5237a6c0a540c14cf6 

    image_in_memory = imread(infile)
    print(image_in_memory.shape)
    # image_in_memory = image_in_memory[0:100, 0:100, 0:100]
    print(image_in_memory.shape)

    # #compress AND change the numpy array into a zarr array
    # # compressor = Blosc(cname='zstd', clevel=3, shuffle=Blosc.BITSHUFFLE)
    # zarray = zarr.array(nparray, chunks=blocksize)

    zarr.save(outfile, image_in_memory)


# import os
# if 'img.zarr' not in os.listdir('../data/'): 




# set model arguments
model_kwargs = {'gpu':False, 'model_type':'nuclei'}
# set evaluation arguments
eval_kwargs = {'diameter':100, 'channels':[0,0], 'do_3D':True}
# set blocksize
blocksize = [241, 500, 500]
...
# convert_tif_to_zarr('../data/nuclei_images/Experiment-347_s1.ome-1.tif', 
# '../data/img.zarr')

# print('file converted to zarr')

print('running seg 0')

masks = distributed_eval(
'../data/img.zarr',
blocksize,
